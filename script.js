...
if (testimonialsCarousel) {
  ...
  function pauseCarousel() {
    ...
    testimonialsCarousel.classList.add('is-paused');
  }

  function resumeCarousel(delay = 0) {
    window.clearTimeout(resumeTimer);
    resumeTimer = window.setTimeout(() => {
      testimonialsCarousel.classList.remove('is-paused');
    }, delay);
  }

  testimonialsCarousel.addEventListener('touchstart', pauseCarousel, { passive: true });
  testimonialsCarousel.addEventListener('touchmove', pauseCarousel, { passive: true });
  testimonialsCarousel.addEventListener('touchend', () => resumeCarousel(900), { passive: true });
  testimonialsCarousel.addEventListener('touchcancel', () => resumeCarousel(900), { passive: true });
